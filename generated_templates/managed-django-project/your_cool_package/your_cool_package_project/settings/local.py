...
DATABASES = {
    'default': {
        ...
        'NAME': str(BASE_PATH / 'your_cool_package-database.sqlite3'),
...
# Download map via geotiler in your_cool_package.gpx_tools.gpxpy2map.generate_map
MAP_DOWNLOAD = True
...
DEBUG_TOOLBAR_CONFIG['SHOW_TOOLBAR_CALLBACK'] = 'your_cool_package_project.middlewares.djdt_show'
