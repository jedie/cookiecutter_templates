...
class ProjectSetupTestCase(TestCase):
    def test_project_path(self):
        ...
        assert_is_dir(project_path / 'your_cool_package')
        assert_is_dir(project_path / 'your_cool_package_project')
    ...
    def test_settings(self):
        self.assertEqual(settings.SETTINGS_MODULE, 'your_cool_package_project.settings.tests')
    ...
    def test_manage(self):
        ...
        self.assertIn('your_cool_package_project', output)
        self.assertIn('your_cool_package_project.settings.local', output)
        self.assertIn('your_cool_package_project.settings.tests', output)
        self.assertIn(__version__, output)
