...
install_import_hook(packages=('{{ cookiecutter.package_name }}', '{{ cookiecutter.django_project_name }}'))


PROJECT_ROOT = Path({{ cookiecutter.package_name }}.__file__).parent.parent
