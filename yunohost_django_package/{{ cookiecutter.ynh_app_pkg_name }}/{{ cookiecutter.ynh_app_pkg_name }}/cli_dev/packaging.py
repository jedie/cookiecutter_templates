...
from {{ cookiecutter.ynh_app_pkg_name }}.cli_dev import app
...
def install():
    """
    Install requirements and '{{ cookiecutter.ynh_app_pkg_name }}' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module={{ cookiecutter.ynh_app_pkg_name }}, package_path=get_project_root())
