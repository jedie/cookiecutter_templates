...
LOG_FILE_PATH = __Path('__LOG_FILE__')  # /var/log/$app/{{ cookiecutter.ynh_app_pkg_name }}.log
...
CACHES = {
    'default': {
        ...
        # If redis is running on same host as {{ cookiecutter.project_name }}, you might
