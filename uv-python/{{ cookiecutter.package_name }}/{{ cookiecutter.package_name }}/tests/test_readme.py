...
from {{ cookiecutter.package_name }}.cli_app import cli
from {{ cookiecutter.package_name }}.cli_dev import PACKAGE_ROOT
from {{ cookiecutter.package_name }}.cli_dev import cli as dev_cli
